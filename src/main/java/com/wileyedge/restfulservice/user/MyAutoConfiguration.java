...
public class MyAutoConfiguration {
	...
	public DataSource dataSource() {
	    ...
	    dataSource.setUrl("jdbc:mysql://localhost:3306/servketDB?createDatabaseIfNotExist=true");
	...
	@Bean
	@ConditionalOnResource(resources = "classpath:mysql.properties") //include additionalProperties bean only if mysql.properties is present in classpath
